A hash table consists of a bucket array and a [[#Hash Functions]] A bucket array for a has table is an array A of size N where each zell of A is thought as a bucket storing a collection of key-value pairs.
